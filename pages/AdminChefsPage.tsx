                    ...
                    <tbody>
                        {chefs.map(item => (
                            <tr key={item.id} className="border-b">
                                <td className="p-3"><img src={getTransformedImageUrl(item.image_url, { width: 300 })} alt={item.name} className="w-16 h-16 object-cover rounded-full"/></td>
                ...
                {editingItem && (
                    <form onSubmit={handleSave} className="p-4 space-y-4 max-h-[80vh] overflow-y-auto">
                        ...
                        <div>
                            ...
                            {editingItem.image_url && <img src={getTransformedImageUrl(editingItem.image_url, { width: 600 })} alt="Current" className="w-24 h-24 mt-2 object-cover rounded-full"/>}
                        </div>
