...
const MenuItemCard: React.FC<{ item: MenuItem; onClick: (item: MenuItem) => void }> = React.memo(({ item, onClick }) => (
  ...
  >
    <img src={item.image_url} alt={item.name} className="w-full h-48 object-cover rounded-md mb-4" loading="lazy" />
        ...
        {selectedItem && (
          <div className="p-4 flex flex-col md:flex-row gap-6">
            <div className="w-full md:w-5/12 flex-shrink-0">
                <div className="aspect-w-1 aspect-h-1 bg-gray-200 rounded-lg shadow-lg overflow-hidden flex items-center justify-center">
